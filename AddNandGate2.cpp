...
void AddNandGate2::Execute()
{
	...
	if (Valid)
	{
		...
		int Len = UI.NAND_Width;
		int Wdth = UI.NAND_Height;
		...
		string Label = "NAND2_" + to_string(Id); //setting a default unique label for the gate
		NAND* pA = new NAND(GInfo, AND2_FANOUT, Id, Label);
