...
{
public:
	XOR2(int r_FanOut); //Overloaded constructor for the load action
	XOR2(const GraphicsInfo& r_GfxInfo, int r_FanOut, int Id, string Label);
	virtual void Operate();	//Calculates the output of the 2-input XOR gate
	virtual void Draw(Output* pOut);	//Draws XOR2 gate
