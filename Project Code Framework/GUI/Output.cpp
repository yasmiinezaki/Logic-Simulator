...
void Output::ClearSimulationBar() const
{
	pWind->SetPen(RED, 1);
	pWind->SetBrush(WHITE);
	pWind->DrawRectangle(UI.width - UI.ToolItemWidth, 0, UI.width, ITM_SIM_CNT * UI.ToolItemWidth);
}
...
void Output::CreateDesignToolBar() const
{
	...
	MenuItemImages[ITM_SWITCH_TO_SIM] = "images\\Menu\\simulation.jpg";
...
void Output::CreateSimulationToolBar() const
{
	...
	MenuItemImages[ITM_SWITCH_TO_DSN] = "images\\Menu\\design.jpg";


	for (int i = 0; i < ITM_SIM_CNT; i++)
		pWind->DrawImage(MenuItemImages[i], (UI.width - UI.ToolItemWidth), i * UI.ToolItemWidth, UI.ToolItemWidth, UI.ToolItemWidth);

	pWind->SetPen(RED, 3);
	pWind->DrawLine(UI.width - UI.ToolItemWidth, 0, UI.width - UI.ToolItemWidth, ITM_SIM_CNT * UI.ToolItemWidth);
